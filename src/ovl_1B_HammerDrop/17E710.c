...
INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F6AF8_17EC28);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F6F9C_17F0CC);
...
INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F74F8_17F628);
...
s32 func_800F7BFC_17FD2C(Object* arg0, f32 arg1) {
    ...
    for (i = 0; i < 4; i++) {
         if (i != temp->unk_24) {
            ...
            temp_f4 = (arg0->unk_18 - temp_v0->unk_18) * (arg0->unk_18 - temp_v0->unk_18);
            temp_f0 = (arg0->unk_20 - temp_v0->unk_20) * (arg0->unk_20 - temp_v0->unk_20);
...
INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7D28_17FE58);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7D64_17FE94);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7DEC_17FF1C);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7E28_17FF58);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7EF4_180024);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7F58_180088);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7F90_1800C0);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F7FFC_18012C);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F8080_1801B0);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F813C_18026C);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F82E0_180410);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F8394_1804C4);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F84A0_1805D0);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F8508_180638);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F896C_180A9C);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F9228_181358);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F9350_181480);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F95E8_181718);
...
INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F9E74_181FA4);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800F9E98_181FC8);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800FA1AC_1822DC);

void func_800FA2D8_182408(void) {
}

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800FA2E0_182410);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800FAA30_182B60);

INCLUDE_ASM(s32, "ovl_1B_HammerDrop/17E710", func_800FB050_183180);
